...
export default function Card({ title, nickname, messages }: cardMessage): JSX.Element {
    ...
    return (
        <main className="grid items-center justify-center mt-12 comfortaa-custom">
            <section className="w-90 md:w-180 min-h-38 grid">
                <div className="relative rounded-md border border-black shadow-[8px_8px_0px_black] hover:shadow-[2px_2px_0px_black] hover:translate-y-1 transition h-full w-full bg-sky-200 p-3 pb-12 md:p-4">
                    <div className='flex font-bold justify-between'>
                        <h2 className="justify-center text-sm md:text-lg font-medium">Dari : {upperNick}</h2>
                        <h3 className='text-sm md:text-lg md:font-extrabold ml-auto text-right'>{upperTitle}</h3>
                    </div>
